...
{
       0,     0,     3,     5,     8,    11,    14,    16,    22
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    14,    -1,    11,    14,    -1,    12,     8,
      -1,    12,    11,    -1,    13,    -1,     4,     5,     6,     3,
       7,    -1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "SEMICOLON", "'\\n'", "$accept", "paingram", "declarations",
  "declaration", "varDeclaration", "block", 0
};
#endif
...
#line 80 "pl.y"
    {
                putVar((yyvsp[(2) - (5)].str), (yyvsp[(4) - (5)].num)); 
                printf("-> I just declared variable '%s' = %d\n", (yyvsp[(2) - (5)].str), (yyvsp[(4) - (5)].num));
        }
    break;
